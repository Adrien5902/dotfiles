...
local animations_enabled = not is_laptop
...
hl.animation({ leaf = "windows",       enabled = animations_enabled,  speed = 4.79, spring = "easy" })
hl.animation({ leaf = "windowsIn",     enabled = animations_enabled,  speed = 4.1,  spring = "easy",         style = "popin 87%" })
hl.animation({ leaf = "windowsOut",    enabled = animations_enabled,  speed = 1.49, bezier = "linear",       style = "popin 87%" })
...
hl.animation({ leaf = "workspacesIn",  enabled = animations_enabled,  speed = 1.21, bezier = "almostLinear", style = "fade" })
hl.animation({ leaf = "workspacesOut", enabled = animations_enabled,  speed = 1.94, bezier = "almostLinear", style = "fade" })
hl.animation({ leaf = "zoomFactor",    enabled = animations_enabled,  speed = 7,    bezier = "quick" })
