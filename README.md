...
Apps :
- Terminal Emulator: [kitty](https://github.com/kovidgoyal/kitty) ([dotfiles](./dot_config/kitty))
- Shell [fish](https://fishshell.com/) ([dotfiles](./dot_config/private_fish/))
- Windows Manager: [Hyprland](https://hypr.land/) ([dotfiles](./dot_config/hypr/hyprland.conf))
